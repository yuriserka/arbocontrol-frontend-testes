...
Cenário: Cadastro com sucesso
    ...
    # novo cenário, e se esconder em um BeforeAll dentro do código fica
    # totalmente escondido pro leitor então o melhor é apenas considerar estes
...
Esquema do Cenário: Excluir a atividade recem cadastrada
    # para os testes, todas as dependencias de uma atividade serão exluidas
    # também, portanto o imovel e equipe criados serão excluidos no AfterAll,
    # mas aqui será especificado apenas a exclusão da atividade em si,
    # no entanto, ao se excluir uma atividade não necessáriamente é
    # preciso excluir suas dependencias
