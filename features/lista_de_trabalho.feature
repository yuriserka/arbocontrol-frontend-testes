...
Esquema do Cenário: Excluir os registros que foram inseridos na lista de trabalho
    Então irei excluir os registros da atividade do tipo "<tipo_atividade_sigla>" do formulario "<formulario>"
...
Cenário: Excluir as dependencias de forma explicita (imovel, equipe)
