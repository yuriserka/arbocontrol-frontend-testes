...
@Record
Funcionalidade: Gravar requisições http para criação e exclusão de Imóveis

@Blaze
Cenário: Login no BlazeMeter e inicio da gravação
    Dado que eu desejo obter um script de carga para a funcionalidade "imoveis"
...
Esquema do Cenário: Excluir as dependencias de forma explicita (territorio)
